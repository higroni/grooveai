"""
Unit tests for Embedding Generator database operations.
...
from modules.embedding_generator.models import EmbeddingJob, EmbeddingType
...
def test_db():
    ...
    from modules.embedding_generator.database import EmbeddingDatabaseManager
    from modules.embedding_generator.models import Base
