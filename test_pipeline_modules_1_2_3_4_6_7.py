...
def test_full_pipeline():
    """Test the complete pipeline from PDF to extracted entities."""
    ...
    # Step 6: Extract entities from assertions
    print("\n[STEP 6] Extracting entities from assertions...")
    ...
    print(f"  - {output_file_txt} (entities text)")
